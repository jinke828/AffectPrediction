...
% Load BOLD signal
load([path,'/data/brain/FNL/a_output/ROIsum.mat']);
...
disp('Saving .....');
if exist([path,'/data/brain/FNL/a_output/FC'])==0
    mkdir([path,'/data/brain/FNL/a_output/FC']);
end

save([path,'/data/brain/FNL/a_output/FC','/sliding-dynFeat.mat'],'dynFeat', '-v7.3');
